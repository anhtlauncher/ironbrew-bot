        ...
        if (message.attachments && message.attachments.first()) {
            ...
            if (attachment.size <= config.max_file_size) {
                let embed = new discord.MessageEmbed()
                    .setTitle("Processing")
                    .setDescription("Obfuscating script, please wait :)")
                    .setColor("ORANGE");
                    ...
                    fetch(attachment.url).then((res) => {
                        if (res.ok) {
                            ...
                            streamPipeline(res.body, outStream).then(async () => {
                                ...
                                let embed = new discord.MessageEmbed()
                                    .setTitle("Obfuscated")
                                    .setDescription("Your script has been obfuscated successfully")
                                    .setColor("GREEN");
                                ...
                                let embed = new discord.MessageEmbed()
                                    .setTitle("Error")
                                    .setDescription("Unable to write file to disk?????? wtf")
                                    .setColor("RED");
                                m.edit({ embeds: [embed] });
                            });
                        } else {
                            let embed = new discord.MessageEmbed()
                                .setTitle("Error")
                                .setDescription("Unable to download file ur script idk why")
                                .setColor("RED");
                            m.edit({ embeds: [embed] });
                        }
                    }).catch((err) => {
                ...
                let embed = new discord.MessageEmbed()
                    .setTitle("Error")
                    .setDescription("Ur script size is too large")
                    .setColor("RED");
            ...
            let embed = new discord.MessageEmbed()
                .setTitle("Error")
                .setDescription("No attachment provided, send the !obfuscate message with an attatchment")
                .setColor("RED");
            message.reply({ embeds: [embed] });
        }
    }
